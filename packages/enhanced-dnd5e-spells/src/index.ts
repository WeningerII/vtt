...
export const ENHANCED_DND5E_SPELLS: Record<string, PhysicsSpellEffect> = {
  ...
  eldritchBlast: {
    ...
    description:
      "A beam of crackling energy streaks toward a creature within range, pushing them back on hit.",
    effects: [
      {
        type: "damage",
        target: "single",
  ...
  guidingBolt: {
    ...
    duration: "Instantaneous",
    description:
      "A flash of light streaks toward a creature, dealing radiant damage and granting advantage on next attack.",
    effects: [
      {
        type: "damage",
        target: "single",
  ...
  faerieFire: {
    ...
    concentration: true,
    description:
      "Objects and creatures in area are outlined in colored light, granting advantage on attacks.",
    effects: [
      {
        type: "condition",
        target: "area",
