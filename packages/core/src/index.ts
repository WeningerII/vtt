...
export { componentFactory, webgpuContextManager, aiProviderRegistry, networkManager, memoryOptimizer };
...
let autoInit = true;
export const _setAutoInit = (_enabled: boolean) => { autoInit = enabled; };
