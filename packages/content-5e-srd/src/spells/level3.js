export const LEVEL_3_SPELLS = {
    fireball: {
        ...
        description: "A bright flash of fire expands from your fingertips to a chosen point within range and then blossoms with a low roar into an explosion of flame. Each creature in a 20-foot-radius sphere centered on that point must make a Dexterity saving throw.",
        ...
        upcastDescription: "When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for each slot level above 3rd.",
    },
    lightningBolt: {
        id: "lightning_bolt",
        name: "Lightning Bolt",
    ...
    counterspell: {
        ...
        upcastDescription: "When you cast this spell using a spell slot of 4th level or higher, the interrupted spell has no effect if its level is less than or equal to the level of the spell slot you used.",
    },
    dispelMagic: {
        id: "dispel_magic",
        name: "Dispel Magic",
    ...
    fly: {
        ...
        upcastDescription: "When you cast this spell using a spell slot of 4th level or higher, you can target one additional creature for each slot level above 3rd.",
    },
    haste: {
        id: "haste",
        name: "Haste",
    ...
    callLightning: {
        ...
        upcastDescription: "When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d10 for each slot level above 3rd.",
    },
    clairvoyance: {
        id: "clairvoyance",
        name: "Clairvoyance",
        ...
        range: "1 mile",
        components: ["V", "S", "M"],
        materialComponent: "a focus worth at least 100 gp, either a jeweled horn for hearing or a glass eye for seeing",
        duration: "Concentration, up to 10 minutes",
        description: "You create an invisible sensor within range in a location familiar to you or in an obvious location that is unfamiliar to you.",
        concentration: true,
        ritual: false,
    ...
    fear: {
        ...
        duration: "Concentration, up to 1 minute",
        description: "You project a phantasmagorical image of a creature's worst fears. Each creature in a 30-foot cone must succeed on a Wisdom saving throw or drop whatever it is holding and become frightened for the duration.",
        savingThrow: { ability: "WIS", dc: 0 },
        concentration: true,
        ritual: false,
    ...
    majorImage: {
        ...
        upcastDescription: "When you cast this spell using a spell slot of 6th level or higher, the spell lasts until dispelled, without requiring your concentration.",
    },
    massHealingWord: {
        ...
        upcastDescription: "When you cast this spell using a spell slot of 4th level or higher, the healing increases by 1d4 for each slot level above 3rd.",
    },
    nondetection: {
        id: "nondetection",
        name: "Nondetection",
        ...
        range: "Touch",
        components: ["V", "S", "M"],
        materialComponent: "a pinch of diamond dust worth 25 gp sprinkled over the target, which the spell consumes",
        duration: "8 hours",
    ...
    speakWithDead: {
        ...
        duration: "10 minutes",
        description: "You grant the semblance of life and intelligence to a corpse of your choice within range, allowing it to answer the questions you pose.",
        concentration: false,
        ritual: false,
        classes: ["Bard", "Cleric"],
        source: "SRD 5.1",
    ...
    spiritGuardians: {
        ...
        duration: "Concentration, up to 10 minutes",
        description: "You call forth spirits to protect you. They flit around you to a distance of 15 feet for the duration.",
        ...
        upcastDescription: "When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d8 for each slot level above 3rd.",
    },
    stinkingCloud: {
        id: "stinking_cloud",
        name: "Stinking Cloud",
    ...
    waterWalk: {
        ...
        duration: "1 hour",
        description: "This spell grants the ability to move across any liquid surface such as water, acid, mud, snow, quicksand, or lava as if it were harmless solid ground.",
        concentration: false,
        ritual: true,
