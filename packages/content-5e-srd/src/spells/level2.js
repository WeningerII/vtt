export const LEVEL_2_SPELLS = {
    holdPerson: {
        ...
        upcastDescription: "When you cast this spell using a spell slot of 3rd level or higher, you can target one additional humanoid for each slot level above 2nd.",
    },
    scorchingRay: {
        id: "scorching_ray",
        name: "Scorching Ray",
        ...
        upcastDescription: "When you cast this spell using a spell slot of 3rd level or higher, you create one additional ray for each slot level above 2nd.",
    },
    mistyStep: {
        id: "misty_step",
        name: "Misty Step",
    ...
    suggestion: {
        ...
        description: "You suggest a course of activity (limited to a sentence or two) and magically influence a humanoid you can see within range that can hear and understand you. The suggestion must be worded in such a manner as to make the activity sound reasonable.",
        savingThrow: { ability: "WIS", dc: 0 },
        concentration: true,
        ritual: false,
        classes: ["Bard", "Sorcerer", "Warlock", "Wizard"],
    ...
    detectThoughts: {
        ...
        duration: "Concentration, up to 1 minute",
        description: "For the duration, you can read the thoughts of certain creatures. When you cast the spell and as your action each turn until the spell ends, you can focus your mind on any one creature that you can see within 30 feet of you.",
        savingThrow: { ability: "WIS", dc: 0 },
        concentration: true,
        ritual: false,
    ...
    spiritualWeapon: {
        ...
        upcastDescription: "When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d8 for every two slot levels above 2nd.",
    },
    shatter: {
        id: "shatter",
        name: "Shatter",
    ...
    acidArrow: {
        ...
        upcastDescription: "When you cast this spell using a spell slot of 3rd level or higher, the damage (both initial and later) increases by 1d4 for each slot level above 2nd.",
    },
    alterSelf: {
        id: "alter_self",
        name: "Alter Self",
    ...
    animalMessenger: {
        ...
        duration: "24 hours",
        description: "By means of this spell, you use an animal to deliver a message. Choose a Tiny beast you can see within range.",
        concentration: false,
        ritual: true,
    ...
    beastSense: {
        ...
        components: ["S"],
        duration: "Concentration, up to 1 hour",
        description: "You touch a willing beast. For the duration of the spell, you can use your action to see through the beast's eyes and speak through the beast's mouth.",
        concentration: true,
        ritual: true,
        classes: ["Druid", "Ranger"],
        source: "SRD 5.1",
    ...
    flameArrow: {
        ...
        duration: "Concentration, up to 1 hour",
        description: "You touch a quiver containing arrows or bolts. When a target is hit by a ranged weapon attack using a piece of ammunition drawn from the quiver, the target takes an extra 1d6 fire damage.",
        ...
        upcastDescription: "When you cast this spell using a spell slot of 3rd level or higher, the number of pieces of ammunition you can affect increases by two for each slot level above 2nd.",
    },
    flamingSphere: {
        id: "flaming_sphere",
        name: "Flaming Sphere",
    ...
    gentleRepose: {
        ...
        range: "Touch",
        components: ["V", "S", "M"],
        materialComponent: "a pinch of salt and a copper piece placed on each of the corpse's eyes, which must remain there for the duration",
        duration: "10 days",
    ...
    magicWeapon: {
        ...
        upcastDescription: "When you cast this spell using a spell slot of 4th level or higher, the bonus increases to +2. When you use a spell slot of 6th level or higher, the bonus increases to +3.",
    },
    moonbeam: {
        id: "moonbeam",
        name: "Moonbeam",
    ...
    protectionFromPoison: {
        ...
        components: ["V", "S"],
        duration: "1 hour",
        description: "You touch a creature. If it is poisoned, you neutralize the poison. If more than one poison afflicts the target, you neutralize one poison that you know is present.",
        concentration: false,
        ritual: false,
    ...
    spike_growth: {
        ...
        duration: "Concentration, up to 10 minutes",
        description: "The ground in a 20-foot radius centered on a point within range twists and sprouts hard spikes and thorns.",
    ...
    summonBeast: {
        ...
        range: "90 feet",
        components: ["V", "S", "M"],
        materialComponent: "a feather, tuft of fur, and fish tail inside a gilded acorn worth at least 200 gp",
        duration: "Concentration, up to 1 hour",
        description: "You call forth a bestial spirit. It manifests in an unoccupied space that you can see within range.",
        concentration: true,
        ritual: false,
        classes: ["Druid", "Ranger"],
        source: "SRD 5.1",
        tags: ["summoning", "beast", "concentration", "costly_components"],
        upcastDescription: "When you cast this spell using a spell slot of 3rd level or higher, use the higher level wherever the spell's level appears in the stat block.",
    },
    zone_of_truth: {
        id: "zone_of_truth",
        name: "Zone of Truth",
