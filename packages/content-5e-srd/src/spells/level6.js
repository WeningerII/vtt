export const LEVEL_6_SPELLS = {
  ...
  contingency: {
    ...
    duration: "10 days",
    description:
      "Choose a spell of 5th level or lower that you can cast, that has a casting time of 1 action, and that can target you. You cast that spell as part of casting contingency, expending spell slots for both.",
    concentration: false,
    ritual: false,
    classes: ["Wizard"],
    source: "SRD 5.1",
  ...
  eyebite: {
    ...
    description:
      "For the spell's duration, your eyes become an inky void imbued with dreadful power. One creature of your choice within 60 feet of you that you can see must succeed on a Wisdom saving throw or be affected by one of the following effects of your choice for the duration.",
  ...
  harm: {
    ...
    duration: "Instantaneous",
    description:
      "You unleash a virulent disease on a creature that you can see within range. The target must make a Constitution saving throw.",
  ...
  heal: {
    ...
    duration: "Instantaneous",
    description:
      "Choose a creature that you touch. The target regains 70 hit points. This spell also ends blindness, deafness, and any diseases affecting the target.",
    concentration: false,
    ritual: false,
  ...
  massHaste: {
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "Choose up to 6 willing creatures within range. Until the spell ends, each target's speed is doubled, it gains a +2 bonus to AC, it has advantage on Dexterity saving throws, and it gains an additional action on each of its turns.",
    concentration: true,
    ritual: false,
    classes: ["Sorcerer", "Wizard"],
    source: "SRD 5.1",
  ...
  trueSeeing: {
    ...
    duration: "1 hour",
    description:
      "This spell gives the willing creature you touch the ability to see things as they actually are. For the duration, the creature has truesight, has a range of 120 feet.",
    concentration: false,
    ritual: false,
