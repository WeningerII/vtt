export const LEVEL_7_SPELLS = {
  delayedBlastFireball: {
    ...
    upcastDescription:
      "When you cast this spell using a spell slot of 8th level or higher, the damage increases by 1d6 for each slot level above 7th.",
  },
  etherealness: {
    id: "etherealness",
    name: "Etherealness",
  ...
  fingerOfDeath: {
    ...
    upcastDescription:
      "When you cast this spell using a spell slot of 8th level or higher, the damage increases by 1d8 for each slot level above 7th.",
  },
  firestorm: {
    id: "firestorm",
    name: "Firestorm",
  ...
  symbolOfStunning: {
    ...
    description:
      "When you cast this spell, you inscribe a harmful symbol either on a surface or within an object that can later hold the symbol.",
    savingThrow: { ability: "CON", dc: 0 },
    concentration: false,
    ritual: false,
