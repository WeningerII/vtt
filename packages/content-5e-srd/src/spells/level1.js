export const LEVEL_1_SPELLS = {
  ...
  createOrDestroyWater: {
    ...
    duration: "Instantaneous",
    description:
      "You either create or destroy water. Create Water: You create up to 10 gallons of clean water within range in an open container.",
    concentration: false,
    ritual: false,
    ...
    upcastDescription:
      "When you cast this spell using a spell slot of 2nd level or higher, you create or destroy 10 additional gallons of water for each slot level above 1st.",
  },
  divineSmite: {
    id: "divine_smite",
    name: "Divine Smite",
    ...
    duration: "Concentration, up to 1 minute",
    description:
      "The next time you hit with a melee weapon attack during the spell's duration, your weapon flares with white-hot intensity.",
