...
export const getSpellsByClass = (className) => getAllSpells().filter(spell => spell.classes.includes(className));
export const getSpellsBySchool = (school) => getAllSpells().filter(spell => spell.school === school);
