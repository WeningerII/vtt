...
export declare class SpellSearchEngine {
     ...
     */
    getSpellsForClass(className: string, characterLevel: number, includeCantrips?: boolean): SRDSpell[];
    /**
     * Get spell suggestions based on character build
     */
    getSpellSuggestions(characterClass: string, characterLevel: number, preferredSchools?: string[], preferredTags?: string[]): SRDSpell[];
    /**
