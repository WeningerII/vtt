...
export declare class ConditionalState extends State {
    ...
    private onTrue?;
    private onFalse?;
    constructor(_name: string, _condition: (context: StateContext) => boolean, onTrue?: () => void, onFalse?: () => void);
    onUpdate(deltaTime: number): void;
}
export declare class StateMachineBuilder {
    ...
    transition(_from: string, _to: string, _condition?: (context: StateContext) => boolean, action?: (_context: StateContext) => void): this;
