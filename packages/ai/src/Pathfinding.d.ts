...
export declare class AStar {
    ...
    static findPath(grid: Grid, start: Vector2, end: Vector2, options?: Partial<PathfindingOptions>): PathfindingResult;
...
export declare class PathfindingManager {
    ...
    findPath(gridId: string, start: Vector2, end: Vector2, options?: Partial<PathfindingOptions>): PathfindingResult;
...
export declare function worldToGrid(_worldPos: Vector2, _cellSize: number, _gridOffset?: Vector2): Vector2;
export declare function gridToWorld(_gridPos: Vector2, _cellSize: number, _gridOffset?: Vector2): Vector2;
