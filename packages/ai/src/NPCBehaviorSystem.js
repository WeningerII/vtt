    ...
    initializeDefaultBehaviors() {
        const defaultBehaviors = [
            ...
            // Flee behavior
            {
                ...
                canExecute: (npc, context) => npc.behaviorState.mood === 'fearful' &&
            ...
            // Attack behavior
            {
                ...
                execute: async (npc, context) => {
                    const threats = context.visibleEntities.filter(e => e.isHostile && e.distance <= npc.stats.attackRange);
                    if (threats.length === 0)
                        return { success: false };
                ...
                canExecute: (npc, context) => npc.behaviorState.mood === 'aggressive' &&
