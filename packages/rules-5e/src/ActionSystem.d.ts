...
export declare class ActionSystem {
     ...
     */
    executeMeleeAttack(attackerId: string, targetId: string, action: AttackAction, advantage?: boolean, disadvantage?: boolean): ActionResult;
    /**
     * Execute a ranged attack
     */
    executeRangedAttack(attackerId: string, targetId: string, action: AttackAction, distance: number, advantage?: boolean, disadvantage?: boolean): ActionResult;
    /**
     * Execute a saving throw
     */
    executeSavingThrow(entityId: string, abilityModifier: number, dc: number, advantage?: boolean, disadvantage?: boolean): ActionResult;
    /**
     * Execute movement
     */
