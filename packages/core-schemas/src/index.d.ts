...
export declare const AssetKindSchema: z.ZodEnum<
  ["ORIGINAL", "DEPTH", "MASK", "TILE", "THUMBNAIL", "METADATA"]
>;
...
export declare const SizeSchema: z.ZodEnum<
  ["TINY", "SMALL", "MEDIUM", "LARGE", "HUGE", "GARGANTUAN"]
>;
export type Size = z.infer<typeof SizeSchema>;
export declare const CreatureTypeSchema: z.ZodEnum<
  [
    "ABERRATION",
    "BEAST",
    "CELESTIAL",
...
export declare const SkillNameSchema: z.ZodEnum<
  [
    "ACROBATICS",
    "ANIMAL_HANDLING",
    "ARCANA",
...
export declare const SenseTypeSchema: z.ZodEnum<
...
export declare const AttackKindSchema: z.ZodEnum<
...
export declare const ActionSchema: z.ZodUnion<
  [
    z.ZodObject<
      {
        name: z.ZodString;
...
export declare const ChallengeRatingSchema: z.ZodEnum<
  [
    "0",
    "1/8",
    "1/4",
