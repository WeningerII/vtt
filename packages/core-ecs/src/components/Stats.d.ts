...
export declare class StatsStore {
    ...
    getSavingThrowModifier(entity: number, ability: keyof AbilityScores, proficient?: boolean): number;
    getSkillModifier(entity: number, ability: keyof AbilityScores, proficient?: boolean, expertise?: boolean): number;
