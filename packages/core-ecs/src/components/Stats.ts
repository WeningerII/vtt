...
export class StatsStore {
  ...
  private strength: Uint8Array;
  private dexterity: Uint8Array;
  private constitution: Uint8Array;
  private intelligence: Uint8Array;
  private wisdom: Uint8Array;
  private charisma: Uint8Array;
  private proficiencyBonus: Uint8Array;
  private armorClass: Uint8Array;
  private speed: Uint8Array;
  ...
  getSavingThrowModifier(entity: number, ability: keyof AbilityScores, proficient = false): number {
