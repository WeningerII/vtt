...
describe('CacheManager', () => {
  ...
  describe('Cache Warmup', () => {
    test('should warm up cache with provided data loader', async () => {
      ...
      await cacheManager.warmup([{ key: 'warmup1', value: warmupData.get('warmup1') }, { key: 'warmup2', value: warmupData.get('warmup2') }, { key: 'warmup3', value: warmupData.get('warmup3') }]);
    ...
    test('should handle warmup failures gracefully', async () => {
      ...
      await expect(cacheManager.warmup([{ key: 'success', value: 'loaded-success' }, { key: 'fail', value: 'loaded-fail' }]))
  ...
  describe('Error Handling', () => {
    test('should handle serialization errors gracefully', async () => {
      ...
      await expect(cacheManager.set('circular', circularObj))
        .resolves.not.toThrow();
    });
