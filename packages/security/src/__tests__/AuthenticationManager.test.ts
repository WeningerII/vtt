...
describe("AuthenticationManager", () => {
  ...
  describe("Session Management", () => {
    ...
    test("should invalidate other sessions", async () => {
      ...
      const invalidatedCount = authManager.invalidateOtherSessions(userId, session3.session!.id);
  ...
  describe("Password Management", () => {
    ...
    test("should change password with valid old password", async () => {
      const result = await authManager.changePassword(userId, "OldPass123!", "NewPass456!");
    ...
    test("should reject password change with invalid old password", async () => {
      const result = await authManager.changePassword(userId, "WrongOldPass", "NewPass456!");
