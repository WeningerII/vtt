...
test.describe('Character Sheet Visual Tests', () => {
  ...
  test('character sheet spell slots section', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="spell-slots-section"]')).toHaveScreenshot('spell-slots-section.png');
  });
  ...
  test('character sheet inventory section', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="inventory-section"]')).toHaveScreenshot('inventory-section.png');
  });
