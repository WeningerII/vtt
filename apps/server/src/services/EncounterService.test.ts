...
import { EncounterService, CreateEncounterRequest, AddParticipantRequest, EncounterSearchOptions } from './EncounterService';
...
describe('EncounterService', () => {
  ...
  describe('addParticipant', () => {
    ...
    it('should throw error for non-existent encounter', async () => {
      ...
      await expect(
        service.addParticipant('invalid-id', request)
  ...
  describe('startEncounter', () => {
    ...
    it('should throw error if no participants', async () => {
      ...
      await expect(
        service.startEncounter(mockEncounterId)
      ).rejects.toThrow('Cannot start encounter without participants');
    });
  });
