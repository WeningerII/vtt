    ...
    oauth: {
      discord: {
        ...
        callbackURL:
          ...
          `${process.env.SERVER_URL || "http://localhost:8080"}/auth/discord/callback`,
      ...
      google: {
        ...
        callbackURL:
          ...
          `${process.env.SERVER_URL || "http://localhost:8080"}/auth/google/callback`,
        scope: ["profile", "email"],
      },
    },
 ...
 */
export function getServiceConfig<T extends keyof ServerConfig>(
  service: T,
  config: ServerConfig,
): ServerConfig[T] {
