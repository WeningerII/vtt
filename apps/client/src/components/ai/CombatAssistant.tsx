...
export const CombatAssistant: React.FC<CombatAssistantProps> = ({ character, allies, enemies, battlefield, isActive }) => {
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4 space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <button className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-700 hover:bg-gray-600 text-gray-300 text-sm rounded transition-colors" aria-label="Click button" >
