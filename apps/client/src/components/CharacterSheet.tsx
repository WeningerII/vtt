...
export const CharacterSheet: React.FC<CharacterSheetProps> = memo((props) => {
  ...
  const InputField = memo(({ field, value, type = 'text', className = '' }: { field: string; value: string | number; type?: 'text' | 'number'; className?: string }) => {
  ...
  const AbilityScore = memo(({ ability, label }: { ability: keyof CharacterData['abilities']; label: string }) => {
  ...
  const SavingThrow = memo(({ ability, label }: { ability: keyof CharacterData['savingThrows']; label: string }) => {
  ...
  const SkillRow = memo(({ skillName, ability, label }: { skillName: string; ability: keyof CharacterData['abilities']; label: string }) => {
    ...
    <div className="main-tab">
      <div className="character-header">
        ...
        <div className="character-stats">
          ...
          <div className="stat-block">
            ...
            <div className="stat-value">{formatModifier(getAbilityModifier(character.abilities.dexterity))}</div>
          </div>
          <div className="stat-block">
      ...
      <div className="hit-points">
        ...
        <div className="hp-section">
          ...
          <div className="hp-value">
            <InputField field="hitPoints.current" value={character.hitPoints.current} type="number" />
          </div>
        </div>
        <div className="hp-section">
          <div className="hp-label">Temporary Hit Points</div>
          <div className="hp-value">
            <InputField field="hitPoints.temporary" value={character.hitPoints.temporary} type="number" />
          </div>
        </div>
      </div>
          ...
          <div key={spell.id} className="spell-item">
            <div className="spell-header">
              <input
                ...
                onChange={(e) => updateField(`spells.knownSpells.${index}.prepared`, e.target.checked)}
                disabled={readOnly}
              />
