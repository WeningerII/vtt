...
export const DiceRoller = memo<DiceRollerProps>(
  ({ onRoll, recentRolls, playerName, readOnly = false }) => {
    ...
    const rollDice = useCallback(
      (diceExpression: string): { result: number; breakdown: string } => {
    ...
    const rollWithAdvantage = useCallback(
      (baseExpression: string): { result: number; breakdown: string } => {
