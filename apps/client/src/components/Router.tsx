...
const GameSession = lazy(() => import('../pages/GameSession').then(m => ({ default: m.GameSession })));
const CharacterEditor = lazy(() => import('../pages/CharacterEditor').then(m => ({ default: m.CharacterEditor })));
const CampaignBrowser = lazy(() => import('../pages/CampaignBrowser').then(m => ({ default: m.CampaignBrowser })));
