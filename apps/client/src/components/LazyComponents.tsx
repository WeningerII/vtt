...
export const LazyCreateCampaignModal = lazy(() =>
  import("./campaigns/CreateCampaignModal").then((module) => ({
    default: module.CreateCampaignModal,
  })),
);

export const LazyCampaignMapManager = lazy(() =>
  import("./campaigns/CampaignMapManager").then((module) => ({
    default: module.CampaignMapManager,
  })),
);
...
export const LazyCombatEncounterPanel = lazy(() =>
  import("./combat/CombatEncounterPanel").then((module) => ({
    default: module.CombatEncounterPanel,
  })),
);
