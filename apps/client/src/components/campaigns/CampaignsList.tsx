  ...
  const CampaignCard: React.FC<{ campaign: Campaign }> = ({ campaign }) => (
    ...
    >
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-neutral-700 line-clamp-2">{campaign.description}</p>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-neutral-700">{campaign.sessions} sessions</span>
          </div>
          <div className="flex items-center gap-2">
            <Clock className="h-4 w-4 text-neutral-500" />
            <span className="text-neutral-700">{campaign.totalHours}h played</span>
          </div>
          <div className="flex items-center gap-2">
